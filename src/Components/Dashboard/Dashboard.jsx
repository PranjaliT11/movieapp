...
import TheatreUpdatate from "../TheatreUpdate/TheatreUpdate";

import Home from "../Home/Home";
import ShowTicket from "../ShowTicket/ShowTicket";
import Profile from "../Profile/Profile";
import SeatUpload from "../SeatUpload/SeatUpload";
import UpdateSeat from "../UpdateSeat/UpdateSeat";
import UpdateMovie from "../UpdateMovie/UpdateMovie";
import AdminTicket from "../AdminTickets/AdminTickets";
            ...
            {isSuperUser && token? (
                <div>
                    ...
                    <div className="dashboardContainerss">
                                                                ...
                                                                movie.map((movies, index) => (
                                                                    ...
                                                                    <tr key={index}>
                                                                        ...
                                                                        <a href="#" class="table-link" onClick={() => DeleteMovie(movies.id)}>
                                                                            <span class="fa-stack">
                                                                                <img src="https://st4.depositphotos.com/1020618/28685/i/450/depositphotos_286856426-stock-photo-cinema-concept-of-vintage-film.jpg"
                        ...
                        {showModal2 && <MovieUpload setShowModal2={setShowModal2} />}
                        {showModal3 && <SeatUpload setShowModal3={setShowModal3} />}
                        {showModal4 && <TheatreUpdatate setShowModal4={setShowModal4} />}
